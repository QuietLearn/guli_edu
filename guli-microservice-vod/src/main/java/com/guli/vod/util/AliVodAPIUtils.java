...
public class AliVodAPIUtils {
    //账号AccessKey信息请填写(必选)
    private static String access_key_id = "LTAIa7jApeI6AOvR";
    //账号AccessKey信息请填写(必选)
    private static String access_key_secret = "oRkId8lazGTUuyogDHrXPN7HNDdUGu";
    ...
    private final static Logger LOG = Logger.getLogger(AliVodAPIUtils.class.getName());
